...
dependencies {
    ...
    compileOnly(project(":adoptimize-cli-compiler-plugin"))
...
val shadowFatJar: ShadowJar = tasks.getByName<ShadowJar>("shadowJar") {
    ...
    dependencies {
        include(project(":adoptimize-cli-compiler-plugin"))
...
publishing {
    publications {
        create<MavenPublication>("diffkt-adoptimize-publishing") {
            artifactId = System.getProperty("ADOptimizeArtifactID")
