...
description = "plugin to prep a differentiable api for optimization"
...
val shadowJar: ShadowJar = tasks.getByName<com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar>("shadowJar") {
