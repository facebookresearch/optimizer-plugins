...
@ToUnboxedFunction("kotlin.Double.plus")
operator fun DifferentiableDouble.plus(other:DifferentiableDouble):DifferentiableDouble {TODO()}

class DoesNotMatter {
    fun doSomethingToDoubles(a:Double):Double {TODO()}
    @ToUnboxedFunction("demo.DoesNotMatter.doSomethingToDoubles")
    fun doSomething(a:DifferentiableDouble):DifferentiableDouble {TODO()}

    <!NO_UNBOXEDFUNCTION_FOUND!>@ToUnboxedFunction("demo.DoesNotMatter.referencedMismatchParameterCount")<!>
